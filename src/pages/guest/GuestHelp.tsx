...
import { guestHelpContent } from "@/data/help-center/guest-content";
      ...
      <header className="sticky top-0 z-10 bg-white border-b">
        <div className="flex items-center px-4 py-3">
          ...
          <EditableWrapper onSave={(value) => console.log("Header edited:", value)}>
            <h1 className="text-lg font-medium">Guest Help Center</h1>
          </EditableWrapper>
        </div>
      </header>
        ...
        <div className="mb-6">
          ...
          <EditableWrapper onSave={(value) => console.log("Description edited:", value)}>
            <p className="text-muted-foreground">
              Find answers to your donation and payment questions
            </p>
          </EditableWrapper>
        </div>
        ...
        <Tabs defaultValue="faq" className="mb-6">
          ...
          <TabsContent value="faq" className="space-y-4 mt-0">
            <Accordion type="single" collapsible>
              {guestHelpContent.faqs.map((faq, index) => (
          ...
          <TabsContent value="docs" className="mt-0">
            <div className="grid gap-4">
              {guestHelpContent.documentation.map((doc, index) => (
                <DocumentationCard
                  key={index}
                  title={doc.title}
